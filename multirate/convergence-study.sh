...
python3 doConvergenceStudy.py precice-config-template.xml -tss radauIIA radauIIA -is BSpline -wd 4 -w 7 -sb 8 8 -o convergence-studies/bspline/multirate_radauIIA_degree4.csv

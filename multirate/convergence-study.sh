...
python3 doConvergenceStudy.py precice-config-template.xml -tss radauIIA radauIIA -is BSpline -wd 4 -sb 16 16 -o convergence-studies/bspline/multirate_radauIIA_degree4.csv